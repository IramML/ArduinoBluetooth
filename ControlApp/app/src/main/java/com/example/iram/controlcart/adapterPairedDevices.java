...
public class adapterPairedDevices extends RecyclerView.Adapter<adapterPairedDevices.ViewHolder>{
    Context context;
    ArrayList<BluetoothDevice> items;
    ClickListener listener;

    public adapterPairedDevices(Context context, ArrayList<BluetoothDevice> items, ClickListener listener){
